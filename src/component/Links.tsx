      ...
      <Flip left>
        <Row align="middle" justify="center" style={{ marginTop: "5%" }}>
          <Col xs={12} sm={4} md={4}>
            <Button
              type="link"
              href="https://www.linkedin.com/in/alessandro-bacci-98b0551b8"
            >
              <Image src={linkedin} width={100} preview={false} />{" "}
            </Button>
          </Col>
          <Col xs={12} sm={4} md={4}>
            {props.theme === "light" ? (
              <Button type="link" href="https://github.com/Ale142">
                <Image src={github_dark} width={100} preview={false} />
              </Button>
            ) : (
              <Button type="link" href="https://github.com/Ale142">
                <Image src={github_light} width={100} preview={false} />{" "}
              </Button>
            )}
          </Col>
